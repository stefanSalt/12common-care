...
const menuItems = computed<MenuItem[]>(() => [
  ...
  { label: '活动报名', index: '/admin/activity-signups', icon: Calendar, permission: 'activitySignup:list' },
  { label: '活动捐赠', index: '/admin/activity-donations', icon: Wallet, permission: 'activityDonation:list' },
  { label: '活动收藏', index: '/admin/activity-favorites', icon: Calendar, permission: 'activityFavorite:list' },
  { label: '数据统计', index: '/admin/stats', icon: TrendCharts, permission: 'stats:view' },
  { label: '爱心事迹', index: '/admin/stories', icon: Document, permission: 'story:list' },
  { label: '评论', index: '/admin/comments', icon: ChatDotRound, permission: 'comment:list' },
